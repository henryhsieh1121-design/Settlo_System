...
function Logo({ size = 34 }) {
  return (
    <div className="flex items-center gap-2.5 select-none">
      ...
      >
        {/* 算盤珠形 S：兩顆珠子錯位排列呼應「算」與「Settlo」首字母 */}
    ...
    <div className="min-h-screen grid lg:grid-cols-[1.05fr_1fr]" style={{ background: 'var(--bg)' }}>
      ...
      >
        ...
        <div className="relative flex items-center gap-2.5 text-white">
          <div className="grid place-items-center w-9 h-9 rounded-xl bg-white/20 backdrop-blur">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <line x1="3" y1="8" x2="21" y2="8" stroke="white" strokeWidth="1.8" strokeLinecap="round" opacity="0.5" />
              <line x1="3" y1="16" x2="21" y2="16" stroke="white" strokeWidth="1.8" strokeLinecap="round" opacity="0.5" />
              <circle cx="15" cy="8" r="3.5" fill="white" />
              <circle cx="9" cy="16" r="3.5" fill="white" />
            </svg>
          </div>
